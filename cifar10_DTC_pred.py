...
if __name__ == "__main__":
    ...
    print('plotting TSNE')
    model.linear= Identity()
    labelled_loader = CIFAR10Loader(root=args.dataset_root, batch_size=args.batch_size, split='train', labeled=True, aug=None, shuffle=False)
    #

    # plot_tsne(eval_loader, model, device,n_clusters=5, filename = 'tsne_test.png')
    plot_tsne_train(labelled_loader, model, device,n_clusters=5, filename = 'tsne_train.png')
